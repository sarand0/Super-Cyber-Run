...
public abstract class Entity {
    ...
    public boolean isCollidingWith(Entity other){
        ...
        if (this.getLeftEdge() > other.getRightEdge()){
            collision = false;
        }else if (this.getTopEdge() > other.getBottomEdge()){
            collision = false;
        }else if (this.getRightEdge() < other.getLeftEdge()){
            collision = false;
        }else if (this.getBottomEdge() < other.getTopEdge()){
            collision = false;
        }
        return collision;
